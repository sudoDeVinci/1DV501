...
"""
This program reads a positive integer as input from a user,
then prints the number of zeros, odd digits, and even digits of the integer.
"""
...
try:
    ...
    # While the input is not all digits, prompt the user for a new input
    while intin.isdigit() is False:
