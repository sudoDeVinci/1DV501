...
- Prints the average value (with two decimals), the minimum, and the maximum.
...
"""
Since we aren't allowed to store the numbers in a data structure
before calculation as a rule,  we must do it on the fly during
iteration right after generation.
"""
